...
public class MultiHartPipelineTests {
    ...
    public void TwoHarts_RunIndependently_BothProduceCorrectResult() {
        ...
        var train0 = new SingleCycleTrain(new Rv64Mechanism(), mem0);
        var train1 = new SingleCycleTrain(new Rv64Mechanism(), mem1);
    ...
    public void HartCount_IsCorrect() {
        ...
        var t0 = new SingleCycleTrain(new Rv64Mechanism(), mem);
        var t1 = new SingleCycleTrain(new Rv64Mechanism(), mem);
        var t2 = new SingleCycleTrain(new Rv64Mechanism(), mem);
    ...
    public void PerHartMoesifCaches_WriteByHart0_ReadByHart1_SeesCoherentValue() {
        ...
        var train0 = new SingleCycleTrain(new Rv64Mechanism(), cache0);
        var train1 = new SingleCycleTrain(new Rv64Mechanism(), cache1, 0x40);
    ...
    public void TwoFiveStageHarts_RunIndependently_BothProduceCorrectResult() {
        ...
        var train0 = new FiveStageTrain(new Rv64Mechanism(), mem0);
        var train1 = new FiveStageTrain(new Rv64Mechanism(), mem1);
    ...
    public void FiveStageHarts_MoesifCoherence_WriteByHart0_ReadByHart1_SeesCoherentValue() {
        ...
        var train0 = new FiveStageTrain(new Rv64Mechanism(), cache0);
        var train1 = new FiveStageTrain(new Rv64Mechanism(), cache1, 0x40);
    ...
    public void TwoSuperscalarHarts_RunIndependently_BothProduceCorrectResult() {
        ...
        var train0 = new SuperscalarTrain(new Rv64Mechanism(), mem0);
        var train1 = new SuperscalarTrain(new Rv64Mechanism(), mem1);
    ...
    public void TwoOoOHarts_RunIndependently_BothProduceCorrectResult() {
        ...
        var train0 = new OooeTrain(new Rv64Mechanism(), mem0);
        var train1 = new OooeTrain(new Rv64Mechanism(), mem1);
    ...
    public void OoOHarts_MoesifCoherence_StoreCommitsThenLoadSeesCoherentValue() {
        ...
        var train1 = new OooeTrain(new Rv64Mechanism(), cache1, 0x40);
    ...
    public void PipelinedHarts_LrScAtomic_ScFailsWhenRemoteStoreIntervenes() {
        ...
        var train0 = new SingleCycleTrain(new Rv64Mechanism(reservationTable: table, hartId: 0), cache0);
        var train1 = new SingleCycleTrain(new Rv64Mechanism(reservationTable: table, hartId: 1), cache1, 0x40);
    ...
    public void OooPipelinedHart_LrScAtomic_ScFailsWhenRemoteStoreIntervenes() {
        ...
        var train0 = new OooeTrain(new Rv64Mechanism(reservationTable: table, hartId: 0), cache0);
        var train1 = new SingleCycleTrain(new Rv64Mechanism(reservationTable: table, hartId: 1), cache1, 0x80);
    ...
    public void RunConcurrent_TwoIndependentHarts_BitIdenticalToSequentialRun() {
        ...
        static (SingleCycleTrain t0, SingleCycleTrain t1) BuildSeq() {
            ...
            var bus = new MoesifBus(flat);
            var t0 = new SingleCycleTrain(new Rv64Mechanism(), new MoesifCache(bus, 256, 2, 64));
            var t1 = new SingleCycleTrain(new Rv64Mechanism(), new MoesifCache(bus, 256, 2, 64), 0x40);
        ...
        var con0 = new SingleCycleTrain(new Rv64Mechanism(), new MoesifCache(def0, 256, 2, 64));
        var con1 = new SingleCycleTrain(new Rv64Mechanism(), new MoesifCache(def1, 256, 2, 64), 0x40);
