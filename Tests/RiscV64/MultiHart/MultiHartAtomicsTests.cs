...
public class MultiHartAtomicsTests {
    ...
    private ExecuteResult Exec(Rv64Executor exe, uint raw, Rv64ArchState state, IMemory mem, ulong pc = 0) {
        ITooth instr = _dec.Decode(pc, raw);
        return exe.Execute(instr, state, mem);
    }

    private static Rv64ArchState MakeState(params (int reg, uint val)[] regs) {
    ...
    public void SingleHart_LrThenSc_Succeeds() {
        ...
        var exe = new Rv64Executor();
        Rv64ArchState s = MakeState((2, 0x10), (3, 0xCAFE));
    ...
    public void SingleHart_ScWithoutLr_Fails() {
        var mem = new FlatMemory(256);
        var exe = new Rv64Executor();
        Rv64ArchState s = MakeState((2, 0x10), (3, 99));
    ...
    public void SingleHart_ScAlwaysReleasesReservation() {
        ...
        var mem = new FlatMemory(256);
        var exe = new Rv64Executor();
        Rv64ArchState s0 = MakeState((2, 0x10));          // LR address
        Rv64ArchState s1 = MakeState((2, 0x20), (3, 99)); // SC at different address
        ...
        Rv64ArchState s2 = MakeState((2, 0x10), (3, 77));
    ...
    public void MultiHart_OtherHartWritesBetweenLrAndSc_ScFails() {
        ...
        var exe0 = new Rv64Executor { ReservationTable = table, HartId = 0, };
        var exe1 = new Rv64Executor { ReservationTable = table, HartId = 1, };

        Rv64ArchState s0 = MakeState((2, 0x10), (3, 0xCAFE)); // hart 0
        Rv64ArchState s1 = MakeState((2, 0x10), (3, 0xDEAD)); // hart 1, same addr
    ...
    public void MultiHart_NoInterveningWrite_ScSucceeds() {
        ...
        var exe0 = new Rv64Executor { ReservationTable = table, HartId = 0, };
        Rv64ArchState s0 = MakeState((2, 0x10), (3, 0x4242));
    ...
    public void MultiHart_WriteToDifferentAddress_DoesNotCancelReservation() {
        ...
        Rv64ArchState s0 = MakeState((2, 0x10), (3, 0x77)); // hart 0 at 0x10
        Rv64ArchState s1 = MakeState((2, 0x20), (3, 0x88)); // hart 1 writes at 0x20
    ...
    public void MultiHart_HartsHoldSeparateReservations() {
        ...
        Rv64ArchState s0 = MakeState((2, 0x10), (3, 0x11));
        Rv64ArchState s1 = MakeState((2, 0x20), (3, 0x22));
