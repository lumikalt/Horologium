...
///     <see cref="ZbkTests" />), the RV64-only packw, and regression coverage for the
...
public class Rv64ZbkTests {
    ...
    private static uint Packw(int rd, int rs1, int rs2) => OpW(0x04, rs2, rs1, 4, rd);
    ...
    private static uint Rev8(int rd, int rs1) => ITypeAlu(0x6B8, rs1, 5, rd);
    ...
    public void Pack_WithX0_IsWordZeroExtendNotHalfwordZextH() {
        ExecuteResult r = Exec(Pack(3, 1, 0), MakeState((1, 0x00000000_FFFFFFFFUL)));
    ...
    public void Pack_UsesXlenOver2Halves() {
        ExecuteResult r = Exec(
            Pack(3, 1, 2),
            MakeState((1, 0x00000000_AAAAAAAAUL), (2, 0x00000000_BBBBBBBBUL))
        );
    ...
    public void Packw_SignExtendsWhenBit31OfPackedResultIsSet() {
        ...
        ExecuteResult r = Exec(
            Packw(3, 1, 2), MakeState((1, 0x1234UL), (2, 0x8000UL))
        );
    ...
    public void Packw_ZeroExtendsWhenBit31OfPackedResultIsClear() {
        ExecuteResult r = Exec(
            Packw(3, 1, 2), MakeState((1, 0x1234UL), (2, 0x7FFFUL))
        );
    ...
    public void Brev8_ReversesAllEightBytesOnRv64() {
        ExecuteResult r = Exec(
            Brev8(3, 1), MakeState((1, 0x0102040800000001UL))
        );
    ...
    public void Brev8_IsSelfInverseOnRv64(ulong x) {
        ...
        ExecuteResult twice = Exec(Brev8(4, 3), MakeState((3, once.RegisterResult.Value)));
        Assert.Equal(x, twice.RegisterResult.Value);
    }

    [Fact]
    public void Rev8Rv64_StillWorksAfterBrev8SharesTop6() {
        ExecuteResult r = Exec(Rev8(3, 1), MakeState((1, 0x0123456789ABCDEFUL)));
    ...
    public void Xperm8_IndexesAllEightBytesOnRv64() {
        ...
        ExecuteResult r = Exec(
            Xperm8(3, 1, 2),
            MakeState((1, 0x0011223344556677UL), (2, 0x0001020304050607UL))
        );
    ...
    public void Xperm8_OutOfRangeIndex_YieldsZeroOnRv64() {
        ...
        ExecuteResult r = Exec(
            Xperm8(3, 1, 2), MakeState((1, ulong.MaxValue), (2, 0x08UL))
        );
    ...
    public void Xperm4_IndexesAllSixteenNibblesOnRv64() {
        ...
        ExecuteResult r = Exec(
            Xperm4(3, 1, 2),
            MakeState((1, 0x0123456789ABCDEFUL), (2, 0xFEDCBA9876543210UL))
        );
    ...
    public void Packh_InheritedUnmodifiedOnRv64() {
        uint raw = RType(0x04, 2, 1, 7, 3);
        ExecuteResult r = Exec(raw, MakeState((1, 0xAAUL), (2, 0xBBUL)));
    ...
    public void Zip_OnRv64_IsIllegalInstruction() {
        Assert.Throws<IllegalInstructionException>(() => _dec.Decode(0, Zip(3, 1)));
    }

    [Fact]
    public void Unzip_OnRv64_IsIllegalInstruction() {
        Assert.Throws<IllegalInstructionException>(() => _dec.Decode(0, Unzip(3, 1)));
    }
}