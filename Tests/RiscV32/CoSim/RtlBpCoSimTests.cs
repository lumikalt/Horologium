...
///     <see cref="OooTrain" />: speculative fetch is steered by RTL predictions
...
public sealed class RtlBpCoSimTests {
    ...
    public void OooeTrain_LoopProgram_CorrectWithRtlPredictor() {
        ...
        var train = new OooTrain(new Rv32Mechanism(), mem, predictor: predictor);
        train.Run();
    ...
    public void OooeTrain_NestedLoops_RtlTageMatchesCSharpLTageCycleForCycle() {
        ...
        // The RTL L-TAGE mirrors the C# LTageBp bit-for-bit, and OooTrain drives
