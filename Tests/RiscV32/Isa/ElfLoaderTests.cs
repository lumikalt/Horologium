...
public class ElfLoaderTests {
    ...
    public void Load_BadMagic_Throws() {
        ...
        bad[2] = (byte)'X';
        bad[3] = (byte)'X';
        Assert.Throws<ElfException>(() => Rv32ElfLoader.Load(new FlatMemory(64), bad));
    }
    ...
    public void Load_WrongArch_Throws() {
        ...
        fake[18] = 0x28;
        fake[19] = 0x00; // EM_ARM
        Assert.Throws<ElfException>(() => Rv32ElfLoader.Load(new FlatMemory(64), fake));
    }

    [Fact]
    public void Load_TooSmall_Throws() {
        Assert.Throws<ElfException>(() => Rv32ElfLoader.Load(new FlatMemory(64), new byte[10]));
    }
