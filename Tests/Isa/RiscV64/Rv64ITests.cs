...
public class Rv64ITests {
    ...
    public void Addw_SignExtends32To64() {
        ...
        const uint raw = (0x00u << 25) | (3u << 20) | (2u << 15) | (0u << 12) | (1u << 7) | 0x3B;
    ...
    public void Subw_SignExtends32To64() {
        ...
        const uint raw = (0x20u << 25) | (3u << 20) | (2u << 15) | (0u << 12) | (1u << 7) | 0x3B;
    ...
    public void Sllw_Uses5BitShamtFromRs2() {
        ...
        const uint raw = (0x00u << 25) | (3u << 20) | (2u << 15) | (1u << 12) | (1u << 7) | 0x3B;
    ...
    public void Srlw_ZeroExtendsBefore32BitShift() {
        ...
        const uint raw = (0x00u << 25) | (3u << 20) | (2u << 15) | (5u << 12) | (1u << 7) | 0x3B;
    ...
    public void Sraw_SignFillsFromBit31() {
        ...
        const uint raw = (0x20u << 25) | (3u << 20) | (2u << 15) | (5u << 12) | (1u << 7) | 0x3B;
    ...
    public void Addiw_OverflowSign() {
        ...
        const uint raw = (1u << 20) | (2u << 15) | (0u << 12) | (1u << 7) | 0x1B;
    ...
    public void Addiw_NegativeImm() {
        ...
        const uint raw = (0xFFFu << 20) | (2u << 15) | (0u << 12) | (1u << 7) | 0x1B;
    ...
    public void Slliw_ShiftsLower32AndSignExtends() {
        ...
        const uint raw = (0x00u << 25) | (1u << 20) | (2u << 15) | (1u << 12) | (1u << 7) | 0x1B;
    ...
    public void Srliw_LogicalShift() {
        ...
        const uint raw = (0x00u << 25) | (1u << 20) | (2u << 15) | (5u << 12) | (1u << 7) | 0x1B;
    ...
    public void Sraiw_ArithmeticShift() {
        ...
        const uint raw = (0x20u << 25) | (1u << 20) | (2u << 15) | (5u << 12) | (1u << 7) | 0x1B;
        Rv64ArchState s = MakeState((2, 0x80000000UL));
        ExecuteResult r = Exec(raw, s);
        Assert.Equal(0xFFFFFFFFC0000000UL, r.RegisterResult.Value);
    }
    ...
    public void Ld_LoadsFullDoubleword() {
        ...
        const uint raw = (0u << 20) | (2u << 15) | (3u << 12) | (1u << 7) | 0x03;
    ...
    public void Sd_StoresFullDoubleword() {
        ...
        const uint raw = (0u << 25) | (3u << 20) | (2u << 15) | (3u << 12) | (0u << 7) | 0x23;
    ...
    public void Lwu_ZeroExtends() {
        ...
        const uint raw = (0u << 20) | (2u << 15) | (6u << 12) | (1u << 7) | 0x03;
    ...
    public void Lw_SignExtends32To64() {
        ...
        const uint raw = (0u << 20) | (2u << 15) | (2u << 12) | (1u << 7) | 0x03;
    ...
    public void Add_64BitResult() {
        // add x1, x2, x3
        const uint raw = 0x003100B3; // same encoding as RV32 add
    ...
    public void Addi_NegativeImmSign64() {
        ...
        const uint raw = (0xFFFu << 20) | (2u << 15) | (0u << 12) | (1u << 7) | 0x13;
        Rv64ArchState s = MakeState((2, 0UL));
        ExecuteResult r = Exec(raw, s);
    ...
    public void Slli_6BitShamt() {
        ...
        const uint raw = (0u << 26) | (32u << 20) | (2u << 15) | (1u << 12) | (1u << 7) | 0x13;
    ...
    public void Srli_6BitShamt() {
        ...
        const uint raw = (0u << 26) | (32u << 20) | (2u << 15) | (5u << 12) | (1u << 7) | 0x13;
    ...
    public void Srai_6BitShamt() {
        ...
        const uint raw = (0x10u << 26) | (32u << 20) | (2u << 15) | (5u << 12) | (1u << 7) | 0x13;
    ...
    public void Slt_64BitSigned() {
        ...
        const uint raw = 0x003120B3; // slt x1, x2, x3
    ...
    public void Blt_64BitSigned_Taken() {
        ...
        const uint raw = (0u << 31) | (0u << 25) | (3u << 20) | (2u << 15) | (4u << 12) | (2u << 8) | (0u << 7) | 0x63;
        Rv64ArchState s = MakeState((2, 0x8000_0000_0000_0000UL), (3, 1UL));
        ExecuteResult r = Exec(raw, s);
