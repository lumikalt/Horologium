...
public class OooRequestBlockGuardTests {
    ...
    public void BlockedEcall_ResumesWhenAnotherHartClearsTheSharedFutexWord() {
        ...
        var train0 = new OooTrain(mech0, mem, entryPoint: 0x00, commitObserver: counter0);
        var train1 = new OooTrain(mech1, mem, entryPoint: 0x40, commitObserver: new PcCommitCounter());
