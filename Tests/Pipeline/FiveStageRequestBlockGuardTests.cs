...
public class FiveStageRequestBlockGuardTests {
    ...
    public void BlockingEcall_RetriesInPlace_ThenProceedsNormallyOnceCleared() {
        ...
        BitConverter.TryWriteBytes(bytes.AsSpan(0), FiveStageRequestBlockGuardTests.Ecall);
        BitConverter.TryWriteBytes(bytes.AsSpan(4), FiveStageRequestBlockGuardTests.AddiX1Plus1);
        BitConverter.TryWriteBytes(bytes.AsSpan(8), FiveStageRequestBlockGuardTests.Ebreak);
        mem.Load(0x00, bytes);
    ...
    public void BlockedEcall_ResumesWhenAnotherHartClearsTheSharedFutexWord() {
        ...
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(0), FiveStageRequestBlockGuardTests.Ecall);
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(4), Addi(2, 2, 1));
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(8), FiveStageRequestBlockGuardTests.Ebreak);
        ...
        BitConverter.TryWriteBytes(hart1Bytes.AsSpan(8), FiveStageRequestBlockGuardTests.Ebreak);
        ...
        var train0 = new FiveStageTrain(mech0, mem, commitObserver: counter0);
        var train1 = new FiveStageTrain(mech1, mem, 0x40, commitObserver: new PcCommitCounter());
