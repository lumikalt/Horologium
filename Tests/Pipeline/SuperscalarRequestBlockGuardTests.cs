...
public class SuperscalarRequestBlockGuardTests {
    ...
    public void BlockingEcall_RetriesInPlace_ThenProceedsNormallyOnceCleared() {
        ...
        BitConverter.TryWriteBytes(bytes.AsSpan(0), SuperscalarRequestBlockGuardTests.Ecall);
        BitConverter.TryWriteBytes(bytes.AsSpan(4), SuperscalarRequestBlockGuardTests.AddiX1Plus1);
        BitConverter.TryWriteBytes(bytes.AsSpan(8), SuperscalarRequestBlockGuardTests.Ebreak);
        mem.Load(0x00, bytes);
    ...
    public void BlockedEcall_ResumesWhenAnotherHartClearsTheSharedFutexWord() {
        ...
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(0), SuperscalarRequestBlockGuardTests.Ecall);
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(4), Addi(2, 2, 1));
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(8), SuperscalarRequestBlockGuardTests.Ebreak);
        ...
        BitConverter.TryWriteBytes(hart1Bytes.AsSpan(8), SuperscalarRequestBlockGuardTests.Ebreak);
        ...
        var train0 = new SuperscalarTrain(mech0, mem);
        var train1 = new SuperscalarTrain(mech1, mem, 0x40);
