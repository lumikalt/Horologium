...
public class CprRequestBlockGuardTests {
    ...
    public void BlockingEcall_RetriesInPlace_ThenProceedsNormallyOnceCleared() {
        ...
        BitConverter.TryWriteBytes(bytes.AsSpan(0), CprRequestBlockGuardTests.Ecall);
        BitConverter.TryWriteBytes(bytes.AsSpan(4), CprRequestBlockGuardTests.AddiX1Plus1);
        BitConverter.TryWriteBytes(bytes.AsSpan(8), CprRequestBlockGuardTests.Ebreak);
        mem.Load(0x00, bytes);
    ...
    public void BlockedEcall_ResumesWhenAnotherHartClearsTheSharedFutexWord() {
        ...
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(0), CprRequestBlockGuardTests.Ecall);
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(4), Addi(2, 2, 1));
        BitConverter.TryWriteBytes(hart0Bytes.AsSpan(8), CprRequestBlockGuardTests.Ebreak);
        ...
        BitConverter.TryWriteBytes(hart1Bytes.AsSpan(8), CprRequestBlockGuardTests.Ebreak);
        ...
        var train0 = new CprTrain(mech0, mem);
        var train1 = new CprTrain(mech1, mem, 0x40);
