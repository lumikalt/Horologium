...
harness; `vgmul.vv` cross-checked against `vghsh.vv` called with an all-zero vs1 (X=0). The remaining
Zvk* family (vector bitmanip: Zvbb/Zvbc/Zvkb) is not yet implemented.
