...
vector-literal indexing detail this port doesn't otherwise need to resolve. The other Zvk* families (GHASH,
vector bitmanip) are not yet implemented.
