...
public sealed class DeferredBus : IBus {
    ...
    /// <summary>
    ///     Queues a read-miss snoop. Returns <see cref="BusReadResponse.NoSharers" />
    ///     (no cache-to-cache supply in phase 1); phase 2 corrects state and data.
    /// </summary>
    ...
    /// <summary>
    ///     Queues an RFO snoop. Returns false (no forwarding in phase 1 — the
    ...
    ///     write already made its Modified copy authoritative.
    /// </summary>
