...
///     <see cref="BranchPredictModels.LTagePredictor" /> bit-for-bit.
///     <para>
...
///     </para>
/// </summary>
public sealed unsafe class RtlFfiHistoryBranchPredictor : IBranchPredictor, IDisposable {
    ...
    public RtlFfiHistoryBranchPredictor(string libraryPath) {
