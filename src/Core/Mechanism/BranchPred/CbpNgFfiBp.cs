...
///     <para>
///         Unlike the CBP-3/5 shim (<see cref="CbpFfiBp" />), cbp-ng's harcom-based
...
///         for a previously unseen indirect branch — the same convention <see cref="CbpFfiBp" />
///         uses.
///     </para>
///     <para>
...
public sealed unsafe class CbpNgFfiBp : IBranchKindAwareBranchPredictor, IDisposable {
    ...
    public CbpNgFfiBp(string libraryPath) {
