...
///         the same convention <see cref="CorrelatedBp" /> uses for its BTB) and falls back
...
///     </para>
/// </summary>
public sealed unsafe class CbpFfiBp : IBranchPredictor, IDisposable {
    ...
    public CbpFfiBp(string libraryPath) {
