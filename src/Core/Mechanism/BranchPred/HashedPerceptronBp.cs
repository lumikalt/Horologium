...
///     </para>
/// </summary>
public sealed class HashedPerceptronBp : IBranchPredictor {
    ...
    /// </param>
    public HashedPerceptronBp(int tableSize = 512, int[]? histLengths = null) {
        _histLengths = histLengths ?? HashedPerceptronBp.DefaultHistLengths;
