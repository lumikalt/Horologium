...
public static class RvHighlighting {
    ...
    public static IHighlightingDefinition GetDefinition() {
        if (RvHighlighting._definition != null) return RvHighlighting._definition;
        using var stream = new MemoryStream(Encoding.UTF8.GetBytes(RvHighlighting.Xshd));
        using var reader = XmlReader.Create(stream);
        RvHighlighting._definition = HighlightingLoader.Load(reader, HighlightingManager.Instance);
        return RvHighlighting._definition;
    }
    ...
    private const string Xshd = """
                                ...
                                <SyntaxDefinition name="RISC-V" xmlns="http://icsharpcode.net/sharpdevelop/syntaxdefinition/2008">
                                  ...
                                  <Color name="Opcode"    foreground="#569CD6" />
